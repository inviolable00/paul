  ...
  const sections = [
    ...
    },
    {
      ...
      desc: [
        ...
        "using a set of universal basis gates, of CNOT, hadamard, NOT (X), and T gates, implemented a simple qc simulator using matrix multiplication, tensor multiplication and direct qubit manipulation to compare the efficiency and downsides of each approach.",
      ...
      link: [
        "https://github.com/feelerx/C_qir",
    ...
    },
    {
      ...
      body: [
        ...
        "PU Learning for Recommender Systems",
        "Ibegwu",
        "MakeMore",
      ],
      desc: [
        "a start up for african languages",
        "designing an inclusive framework for modelling the best possible scenario for performing multiple quantum tasks in parallel across several hardware",
        "generalizing an approach for efficient prediction in recommender systems by not estimating a class prior",
      ...
      link: [
        ...
        "",
        "https://github.com/feelerx/pu_learning_RS",
